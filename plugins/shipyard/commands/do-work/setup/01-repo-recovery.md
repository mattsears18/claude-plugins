...
- **Cost** — all blocker lookups read through the [`blocker_state` cache](00-config-worktree.md#08-blocker_state-cache-default-on) and fire as a parallel burst. Combined extra cost on a ~50-issue backlog is well under 1s wall-clock.
